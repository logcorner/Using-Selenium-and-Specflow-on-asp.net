...
namespace LogCorner.BlogPost.Web.Mvc.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var result = Mapper.Map<IEnumerable<BlogViewModel>>(list);
            return View(result);
        }
        ...
        public ActionResult Details(int id)
        {
            ...
            var result = Mapper.Map<BlogForDetailViewModel>(list);
            return View(result);
        }
        ...
        public ActionResult Create(BlogForCreationViewModel blogViewModel)
        {
            ...
            var blog = Mapper.Map<Blog>(blogViewModel);
        ...
        {
            var list = _blogService.Get(id);
            var result = Mapper.Map<BlogForEditViewModel>(list);
            return View(result);
        }
        ...
        public ActionResult Delete(int id)
        {
            ...
            var result = Mapper.Map<BlogForDetailViewModel>(details);
            return View(result);
        }
        ...
        public ActionResult Delete(int id, BlogForDetailViewModel BlogForDetailViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                var details = _blogService.Get(id);
                BlogForDetailViewModel = Mapper.Map<BlogForDetailViewModel>(details);
